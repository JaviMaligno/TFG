...
PONER EJEMPLO CONOCIDO DE ESPACIO DE CONFIGURACIÓN (R2 MENOS DOS PUNTOS)
...
Un espacio topológico $X$ se dice que es \emph{semilocalmente simplemente conexo} si todo punto $x\in X$ tiene un entorno tal que la inclusión inducida $\pi_1(U)\to\pi_1(X)$ es trivial. ¿ESTO NO ES LO MISMO QUE DECIR QUE U SEA SIMPLEMENTE CONEXO?
\end{defi}
