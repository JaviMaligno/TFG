...
\newpage
Por lo general, hay dos técnicas principales para resolver el problema de la palabra:
\begin{itemize}
...
\begin{itemize}
\item Suma de los exponentes: en cualquier grupo con relaciones homogéneas, para que un elemento represente el neutro, la suma de los exponentes de los generadores que lo representan debe ser cero. Esto se puede considerar como una representación no fiel (morfismo no inyectivo) $\varphi:G\to \Z$. En general, una representación no fiel nos dará una solución parcial al problema de la palabra.
