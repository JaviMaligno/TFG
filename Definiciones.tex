...
\begin{ej}
En el ejemplo de espacio recubridor anterior, las transformaciones del recubrimiento son las aplicaciones de la forma $f(t)=t+n$ para cada $n\in\Z$, por lo que $G(\widetilde{X})\cong\Z$. En particular, $\Z$ actúa sobre el espacio recubridor mediante $f$. 
\end{ej}
