...
Para la segunda parte, supongamos que tenemos $h_1g_1=h_2g_2\in F\times\{e_G\}$ con $h_1,h_2\in F$ y $g_1,g_2\in G$. Entonces consideramos la proyección $p:F\rtimes G\to G$, de modo que $g_1=p(h_1g_1)=p(h_2g_2)=g_2$. Ahora basta multiplicar a derecha por $g_1^{-1}$ para obtener $h_1=h_2$.
\QED
