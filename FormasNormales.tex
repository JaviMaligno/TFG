...
EXPLICAR EL ALGORITMO POR BLOQUES CITANDO QUE ESTÁ EN THURSTON
...
Ahora vamos a hacer la separación de bloques en las palabras positivas. 


NO LE VEO SENTIDO A LOS EJEMPLOS QUE ME PUSO, CÓMO VA A SER SIMPLE UNA TRENZA QUE TIENE REPETIDOS LOS GENERADORES, ESO NO CUADRA CON LA DEFINICIÓN QUE DI EN PEINADO DE TRENZAS. TAMPOCO VEO CÓMO TE VAN A SALIR DELTAS (SUPONGO QUE UNIENDO VARIOS BLOQUES) DURANTE EL PROCESO SI EN TODO MOMENTOS VAS HACIENDO TRENZAS SIMPLES. DE HECHO THURSTON 9.1.14 DICE QUE ES EQUIVALENTE SER ELEMENTO SIMPLE COMO PREFIJO DE DELTA Y QUE LOS GENERADORES NO SE REPITAN, AUNQUE EL TERCER TROZO DE LA FIGURA 9.3 PARECE QUE REPITE SIGMA2
\end{ej}
